...
def predict():
    errors=[]
    # Initialize message and emotion to handle cases where the form is empty
    message = ""
    emotion = ""
    ...
    # Pass the user's original text (message) back to the template
    return render_template('home.html', prediction=emotion, errors=errors, user_text=message)
